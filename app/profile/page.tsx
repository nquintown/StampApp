...
function SettingRow({ iconBg, iconEl, label, sublabel, value, badge, rightSlot, onPress, isLast, disabled }: RowProps) {
  ...
  return (
    <div>
      ...
      {!isLast && (
        <div style={{ height: 1, backgroundColor: 'var(--border)', marginLeft: 66, transition: 'background-color 0.25s ease' }} />
      )}
    </div>
  )
}
      ...
      >
        ...
        >
          {[
            ...
            { value: userCollections.length, label: 'Collections' },
            { value: 0, label: 'Jours 🔥' },
          ].map((stat, i) => (
            <div
              key={i}
      ...
      >
          ...
          <SettingRow
            ...
            iconEl={
              <svg width="18" height="18" viewBox="0 0 18 18" fill="none" color={isDark ? '#818CF8' : '#F59E0B'}>
                {isDark ? (
                  <path d="M14.5 10.5A6.5 6.5 0 0 1 7.5 3.5a6.5 6.5 0 1 0 7 7z"
        ...
        <Section title="Découvrir">
          <SettingRow
            iconBg="#DBEAFE"
            iconEl={
              <svg width="18" height="18" viewBox="0 0 18 18" fill="none" color="#3B82F6">
                <circle cx="7" cy="7" r="3" stroke="currentColor" strokeWidth="1.4" />
                <path d="M1.5 15C1.5 12.5 4 10.5 7 10.5" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" />
                <path d="M13.5 10.5V15.5M11 13H16" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" />
              </svg>
            }
            label="Mes amis"
          ...
          <SettingRow
            iconBg="#D1FAE5"
            iconEl={
              <svg width="18" height="18" viewBox="0 0 18 18" fill="none" color="#10B981">
                <path d="M13 3L17 7L13 11V8.5C8 8.5 5 10.5 4 15C3.5 11 5 6 13 5.5V3Z"
                  stroke="currentColor" strokeWidth="1.4" strokeLinejoin="round" />
              </svg>
            }
            label="Partager un stamp"
            sublabel="Envoie un stamp à un ami"
            badge="Bientôt"
            disabled
            isLast
          />
        ...
        <Section title="Retours">
          <SettingRow
            iconBg="#FEF3C7"
            iconEl={
              <svg width="18" height="18" viewBox="0 0 18 18" fill="none" color="#F59E0B">
                <path d="M9 2L11 7H16.5L12 10.5L14 16L9 12.5L4 16L6 10.5L1.5 7H7L9 2Z"
                  stroke="currentColor" strokeWidth="1.4" strokeLinejoin="round" />
              </svg>
            }
          ...
          <SettingRow
            iconBg="#EDE9FE"
            iconEl={
              <svg width="18" height="18" viewBox="0 0 18 18" fill="none" color="#8B5CF6">
                <path d="M2 3.5C2 2.67 2.67 2 3.5 2H14.5C15.33 2 16 2.67 16 3.5V11.5C16 12.33 15.33 13 14.5 13H10L6 16V13H3.5C2.67 13 2 12.33 2 11.5V3.5Z"
                  stroke="currentColor" strokeWidth="1.4" strokeLinejoin="round" />
              </svg>
            }
            label="Support"
