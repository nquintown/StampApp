    ...
    <div>
      ...
      <div style={{ position: 'relative' }}>
        ...
        <input
          ...
          style={{
            width: '100%',
            padding: `14px ${showToggle ? '44px' : '14px'} 14px 42px`,
    ...
    <div className="app-shell" style={{
      ...
      >
        ...
        <form onSubmit={handleRegister} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          <InputField
            label="Enter your email" type="email" value={email} onChange={setEmail}
          ...
          />
          <InputField
            label="Enter your password" value={password} onChange={setPassword}
            placeholder="••••••••••••"
          ...
          />
          <InputField
            label="Re-enter your password" value={confirm} onChange={setConfirm}
            placeholder="••••••••••••"
            icon={<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6"><rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>}
